...
import controller.VentanaAgentesControlador;
...
public class VentanaAgentes {
	...
	private VentanaAgentesControlador controlador;

	public VentanaAgentes(VentanaMenu ventanaMenu) {
		this.controlador = new VentanaAgentesControlador(this, ventanaMenu);
		ventanaAgente();
	}
	...
	public void setControlador(VentanaAgentesControlador controlador) {
